...
- **lesson-49:** Ядро. Сборка ядра и загрузка на эмуляторе
- **lesson-54:** Модули ядра. Простой модуль ядра, использующий файл символьного устройства для обмена данными с пользовательским пространством
